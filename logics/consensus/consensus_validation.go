...
func (v *ConsensusValidation) Validate(block *common.Block, namespace string, txPosition int, actionPosition int, contextData ...validation.ContextDatum) error {
...
func (v *ConsensusValidation) Init(dependencies ...validation.Dependency) error {
	var (
